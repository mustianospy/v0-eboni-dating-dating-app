            ...
            <div className="flex items-center space-x-4">
              <Link href="/matches">
                <Button
                  variant="ghost"
                  size="sm"
                  className="hover:bg-violet-100 dark:hover:bg-violet-900 transition-colors"
                >
        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <Badge
                      className={getSubscriptionColor(user.subscriptionTier)}
                    >
          ...
          <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-muted-foreground mb-4">
                        Get unlimited swipes, super likes, and access to
                        exclusive features
                      </p>
                    </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Your profile is now complete! Start discovering amazing people
                  in your community. Remember to stay safe and have fun
