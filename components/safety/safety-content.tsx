    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Manage your safety settings and privacy controls to ensure a secure
          dating experience.
        </p>
      </div>
        ...
        <TabsContent value="settings" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Control how sensitive content is displayed and moderated
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Automatically blur potentially sensitive images
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Use AI to detect and filter inappropriate content
                  </p>
                </div>
                <Switch
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="p-3 bg-muted rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Always meet new connections in public places for your first
                    few dates.
                  </p>
                </div>
                <div className="p-3 bg-muted rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    If something feels off, don't hesitate to block or report
                    the user.
                  </p>
                </div>
                <div className="p-3 bg-muted rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Don't share sensitive information like your address or
                    financial details.
                  </p>
                </div>
              </div>
