            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="support-email"
                  type="email"
                  defaultValue="support@ebonidating.com"
                />
              </div>
        ...
        <TabsContent value="security">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure security and moderation features
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Automatically moderate user content using AI
                  </p>
                </div>
                <Switch
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="from-email"
                  type="email"
                  defaultValue="noreply@ebonidating.com"
                />
              </div>
