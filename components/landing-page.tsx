    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-pink-50 to-orange-50 dark:from-violet-950 dark:via-pink-950 dark:to-orange-950">
          ...
          <nav className="flex items-center justify-between" role="navigation" aria-label="Main navigation">
            <div className="flex items-center space-x-3">
              <div className="relative">
                <Heart className="h-10 w-10 text-violet-600 fill-current" aria-hidden="true" />
                <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-pink-500 to-orange-500 rounded-full animate-pulse"></div>
              </div>
              <span className="text-3xl font-bold bg-gradient-to-r from-violet-600 via-pink-600 to-orange-500 bg-clip-text text-transparent">
                EboniDating
              </span>
            </div>
      ...
      <section className="relative container mx-auto px-4 py-20">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-br from-pink-400/20 to-orange-400/20 rounded-full blur-xl animate-pulse animation-delay-1000"></div>
          <div className="absolute bottom-20 left-1/4 w-40 h-40 bg-gradient-to-br from-orange-400/20 to-violet-400/20 rounded-full blur-xl animate-pulse animation-delay-2000"></div>
        </div>
        ...
        <div className="relative z-10 text-center">
          <div className="mb-8 flex justify-center space-x-4">
            ...
            <div className="relative group">
              <img
                ...
                className="w-20 h-20 rounded-full object-cover border-4 border-pink-200 shadow-lg group-hover:scale-110 transition-transform duration-300 animation-delay-100"
              />
              <div className="absolute -top-2 -right-2 w-6 h-6 bg-pink-500 rounded-full border-2 border-white animate-pulse"></div>
            </div>
            <div className="relative group">
              <img
                src="/outdoor-hiking-adventure.png"
                alt="Adventure together"
                className="w-20 h-20 rounded-full object-cover border-4 border-orange-200 shadow-lg group-hover:scale-110 transition-transform duration-300 animation-delay-200"
              />
              <div className="absolute -top-2 -right-2 w-6 h-6 bg-orange-500 rounded-full border-2 border-white animate-bounce animation-delay-500"></div>
            </div>
          </div>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
            ...
            <br />
            <span className="bg-gradient-to-r from-pink-600 via-orange-500 to-violet-600 bg-clip-text text-transparent">
              Perfect Match
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-xl px-12 py-6 border-2 border-violet-300 hover:border-violet-500 hover:bg-violet-50 dark:hover:bg-violet-950 transition-all duration-300 rounded-full bg-transparent"
      ...
      <section className="relative py-20 bg-white/50 dark:bg-black/50 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2
              className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-violet-600 via-pink-600 to-orange-500 bg-clip-text text-transparent"
              id="features"
            >
        ...
        <div className="relative container mx-auto px-4">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center space-x-3 mb-6">
              ...
              <span className="text-3xl font-bold bg-gradient-to-r from-pink-400 to-orange-400 bg-clip-text text-transparent">
                EboniDating
              </span>
            </div>
            <div className="flex justify-center space-x-8 mb-6">
              <Link href="/auth/signin" className="hover:text-pink-400 transition-colors">
                Sign In
              </Link>
              ...
              <Link href="/subscription" className="hover:text-pink-400 transition-colors">
                Premium
              </Link>
            </div>
            <p className="text-pink-200 text-lg flex items-center justify-center gap-2">
              © 2024 EboniDating. All rights reserved. Made with <Heart className="h-4 w-4 text-pink-400" /> for the
              community.
            </p>
          </div>
        </div>
